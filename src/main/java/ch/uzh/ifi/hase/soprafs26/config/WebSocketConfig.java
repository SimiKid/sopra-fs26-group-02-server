...
/**
 * STOMP-over-WebSocket setup. Clients connect to /ws (SockJS fallback),
 * subscribe to /topic/... for server push, and send to /app/... for
 * server-handled messages (see BattleWebSocketController).
 */
@Configuration
